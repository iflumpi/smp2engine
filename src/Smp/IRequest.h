...
public:
    ...
    public:
        ...
        InvalidParameterIndex(String8 _operationName, const Int32 _parameterIndex) throw()
            : Smp::Exception("InvalidParameterIndex"), operationName(_operationName), parameterIndex(_parameterIndex)
        {
            description = new Char8[std::strlen(InvalidParameterIndexTemplate) + 8 + std::strlen(operationName)];

            std::sprintf(description, InvalidParameterIndexTemplate, parameterIndex, operationName); // NOLINT
        }
        ~InvalidParameterIndex() throw() = default;
    };
    ...
    public:
        ...
        InvalidParameterValue(String8 _parameterName, const AnySimple& _value) throw()
            : Smp::Exception("InvalidParameterValue"), parameterName(_parameterName), value(_value)
        {
            description = new Char8[std::strlen(InvalidParameterValueTemplate) + std::strlen(parameterName)];

            std::sprintf(description, InvalidParameterValueTemplate, parameterName); // NOLINT
        }

        virtual ~InvalidParameterValue() throw() = default;
    };
    ...
    public:
        ...
        InvalidReturnValue(String8 _operationName, const AnySimple& _value) throw()
            : Smp::Exception("InvalidReturnValue"), operationName(_operationName), value(_value)
        {
            description = new Char8[std::strlen(InvalidReturnValueTemplate) + std::strlen(operationName)];

            std::sprintf(description, InvalidReturnValueTemplate, operationName); // NOLINT
        }

        virtual ~InvalidReturnValue() throw() = default;
    };
    ...
    public:
        ...
        VoidOperation(String8 _operationName) throw() : Smp::Exception("VoidOperation"), operationName(_operationName)
        {
            description = new Char8[std::strlen(VoidOperationTemplate) + std::strlen(operationName)];

            std::sprintf(description, VoidOperationTemplate, operationName); // NOLINT
        }
        ~VoidOperation() throw() = default;
    };
