...
public:
    ...
    virtual void AddImmediateEvent(const IEntryPoint* entryPoint) = 0;
    ...
    virtual EventId AddSimulationTimeEvent(const IEntryPoint* entryPoint, Duration simulationTime, Duration cycleTime = 0, Int64 count = 0)
        = 0;
    ...
    ///          event will never be executed, but immediately removed.
    virtual EventId AddMissionTimeEvent(const IEntryPoint* entryPoint, Duration missionTime, Duration cycleTime = 0, Int64 count = 0)
        = 0;
    ...
    ///          time of the ITimeKeeper service. Otherwise, the
    ///          event will never be executed, but immediately removed.
    virtual EventId AddEpochTimeEvent(const IEntryPoint* entryPoint, DateTime epochTime, Duration cycleTime = 0, Int64 count = 0)
        = 0;
    ...
    ///          time of the ITimeKeeper service. Otherwise, the
    ///          event will never be executed, but immediately removed.
    virtual EventId AddZuluTimeEvent(const IEntryPoint* entryPoint, DateTime zuluTime, Duration cycleTime = 0, Int64 count = 0) = 0;
    ...
    ///          The simulationTime must not be negative. Otherwise, the
    ///          event will never be executed, but immediately removed.
    virtual void SetEventSimulationTime(EventId event, Duration simulationTime) = 0;
    ...
    ///          For a cyclic event, the cycleTime needs to be positive.
    ///          For non-cyclic events, it is ignored.
    virtual void SetEventCount(EventId event, Int64 count) = 0;
