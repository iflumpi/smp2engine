...
public:
    ...
    virtual Smp::Services::LogMessageKind GetLogMessageKind(Smp::String8 messageKindName) = 0;
    ...
    virtual void Log(const IObject* sender, String8 message, LogMessageKind kind = LMK_Information) = 0;
};
}
}
