...
public:
    ...
    public:
        ...
        AlreadySubscribed(const IEventSource* _eventSource, const IEventSink* _eventSink) throw()
            : Smp::Exception("AlreadySubscribed"), eventSource(_eventSource), eventSink(_eventSink)
        {
            ...
            description = new Char8[std::strlen(AlreadySubscribedTemplate) + std::strlen(sourceName) + std::strlen(sinkName)];

            std::sprintf(description, AlreadySubscribedTemplate, sinkName, sourceName); // NOLINT
        }
        ~AlreadySubscribed() throw() = default;
    };
    ...
    public:
        ...
        NotSubscribed(const IEventSource* _eventSource, const IEventSink* _eventSink) throw()
            : Smp::Exception("NotSubscribed"), eventSource(_eventSource), eventSink(_eventSink)
        {
            Smp::String8 sourceName = "NULL";
            Smp::String8 sinkName = "NULL";
            ...
            description = new Char8[std::strlen(NotSubscribedTemplate) + std::strlen(sourceName) + std::strlen(sinkName)];

            std::sprintf(description, NotSubscribedTemplate, sinkName, sourceName); // NOLINT
        }

        ~NotSubscribed() throw() = default;
    };
    ...
    public:
        ...
        InvalidEventSink(const IEventSource* _eventSource, const IEventSink* _eventSink) throw()
            : Smp::Exception("InvalidEventSink"), eventSource(_eventSource), eventSink(_eventSink)
        {
            Smp::String8 sourceName = "NULL";
            Smp::String8 sinkName = "NULL";
            ...
            description = new Char8[std::strlen(InvalidEventSinkTemplate) + std::strlen(sourceName) + std::strlen(sinkName)];

            std::sprintf(description, InvalidEventSinkTemplate, sinkName, sourceName); // NOLINT
        }
        ~InvalidEventSink() throw() = default;
    };
