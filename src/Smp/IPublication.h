...
public:
    ...
    InvalidFieldType(Smp::SimpleTypeKind _invalidType) throw()
        : Exception("InvalidFieldType"), invalidType(_invalidType)
    {
        description = new Char8[std::strlen(InvalidFieldTypeTemplate) + std::strlen(TypeName[invalidType])];

        std::sprintf(description, InvalidFieldTypeTemplate, TypeName[invalidType]); // NOLINT
    }
    ~InvalidFieldType() throw() = default;
};
}
}
...
public:
    ...
    virtual void PublishField(
        String8 name, String8 description, Char8* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Bool* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Int8* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Int16* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Int32* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Int64* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, UInt8* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, UInt16* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, UInt32* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, UInt64* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Float32* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(
        String8 name, String8 description, Float64* address, Bool view = true, Bool state = true, Bool input = false, Bool output = false)
        = 0;
    ...
    /// @param input True if field is an input field, false otherwise.
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishField(String8 name,
                              String8 description,
                              void* address,
                              Smp::Uuid typeUuid,
                              Bool view = true,
    ...
    /// @param input True if field is an input field, false otherwise.
    /// @param output True if field is an output field, false otherwise.
    virtual void PublishArray(String8 name,
                              String8 description,
                              Int64 count,
                              void* address,
                              SimpleTypeKind type,
    ...
    /// @param name Array name.
    /// @param description Array description.
    virtual IPublication* PublishArray(String8 name, String8 description) = 0;

    /// Publish structure.
    /// @param name Structure name.
    /// @param description Structure description.
    virtual IPublication* PublishStructure(String8 name, String8 description) = 0;
    ...
    virtual Publication::IPublishOperation* PublishOperation(String8 name, String8 description, Smp::Uuid returnTypeUuid) = 0;
    ...
    virtual void PublishProperty(String8 name, String8 description, Smp::Uuid typeUuid, AccessKind accessKind) = 0;
    ...
    virtual void GetArrayValue(String8 fullName, AnySimpleArray values, Int32 length) = 0;
    ...
    virtual void SetArrayValue(String8 fullName, AnySimpleArray values, Int32 length) = 0;
